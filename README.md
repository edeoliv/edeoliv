# Hey there! 👋 I'm Elias Olivtradet

**🚀 Founder | CoFounder & CTO | Software Engineer & Tech Leader in Estonian Startup**

Passionate about crafting **efficient and innovative** software solutions, specializing in **modern web technologies** and **blockchain development**.
...
- **Enterprise SaaS Applications** - POS, CRM, ERP systems
- **Blockchain & Web3 Solutions** - Smart contracts, DApps
- **Scalable Multi-tenant Architectures** - Laravel + Filament
- **Tax Compliance Systems** - Verifactu integration for Spanish market & Ticket Bai integration for Basque market
